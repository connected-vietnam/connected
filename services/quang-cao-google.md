...
|Báo cáo						 |Image         |Image/CSV/2 tuần lần|CSV/ Teamview/Show|
...
- Tối ưu quảng cáo chỉ làm được ở mức tối ưu được nhấp chuột mong đợi và mức độ liên quan từ khóa với mẫu quảng cáo, không bao gồm tối ưu trang đích.
- Tích hợp Google Tag Manager (GTM) để chèn code phụ thuộc Website.
- Có thể tích hợp thêm Facebook Pixel vào GTM để chạy chiến dịch quảng cáo facebook với những người đã truy cập trang Website.